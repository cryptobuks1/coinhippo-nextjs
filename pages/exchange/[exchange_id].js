          ...
          <>
            ...
            <span>
              {exchangeData.country && (
                <Badge size="sm" rounded color="bg-blue-500 text-gray-100 dark:bg-blue-700 mr-1.5">{exchangeData.country}</Badge>
              )}
              {exchangeData.year_established && (
                <Badge size="sm" rounded color="bg-gray-200 text-gray-600 dark:bg-gray-600 dark:text-gray-200">{exchangeData.year_established}</Badge>
              )}
            </span>
          </>
          :
