    ...
    <>
      ...
      <div className="flex flex-col space-y-12">
        ...
        <div className="w-full grid grid-flow-row grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
          {[
            {
              src: `${process.env.NEXT_PUBLIC_SITE_URL}/coin/bitcoin?view=widget${background === 'dark' ? `&theme=${background}` : ''}`,
              title: 'Bitcoin',
              width: 300,
              height: 240,
            },
            {
              src: `${process.env.NEXT_PUBLIC_SITE_URL}/coin/ethereum?view=widget${background === 'dark' ? `&theme=${background}` : ''}`,
              title: 'Ethereum',
              width: 300,
              height: 240,
            },
            {
              src: `${process.env.NEXT_PUBLIC_SITE_URL}/coin/dogecoin?view=widget${background === 'dark' ? `&theme=${background}` : ''}`,
              title: 'Dogecoin',
              width: 300,
              height: 240,
            },
            {
              src: `${process.env.NEXT_PUBLIC_SITE_URL}/coin/axie-infinity?view=widget${background === 'dark' ? `&theme=${background}` : ''}`,
              title: 'Axie Infinity',
              width: 300,
              height: 240,
            },
        ...
        <div className="w-full grid grid-flow-row grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            ...
            {
              src: `${process.env.NEXT_PUBLIC_SITE_URL}/coins?view=widget&n=10${background === 'dark' ? `&theme=${background}` : ''}`,
        ...
        <div className="w-full grid grid-flow-row grid-cols-1 sm:grid-cols-2 gap-4">
          {[
            {
              src: `${process.env.NEXT_PUBLIC_SITE_URL}/coins/decentralized-finance-defi?view=widget&n=10${background === 'dark' ? `&theme=${background}` : ''}`,
              title: 'Top DeFi',
              width: 600,
              height: 900,
            },
            {
              src: `${process.env.NEXT_PUBLIC_SITE_URL}/coins/non-fungible-tokens-nft?view=widget&n=10${background === 'dark' ? `&theme=${background}` : ''}`,
              title: 'Top NFTs',
              width: 600,
              height: 900,
            },
