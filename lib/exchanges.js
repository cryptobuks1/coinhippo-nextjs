...
export const getTrades = (coinData, allCryptoData, tickers) => {
  ...
  if (coinData && coinData.id) {
    trades = _.orderBy(customTrades.map(ex => {
      ...
      return {
        ...
        match: ex.support_coins.findIndex(c => c.base === coinData.id) > -1,
      }
    }), ['match'], ['desc'])
  }
