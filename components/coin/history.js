          ...
          <div className="w-full grid grid-flow-row grid-cols-2 sm:grid-cols-4 lg:grid-cols-8 gap-4 lg:gap-2">
            {['price_change_percentage_1h_in_currency',
              ...
              <div key={i} className="flex flex-col items-start">
                <span className="uppercase text-gray-400 dark:text-gray-500">{field.split('_')[3]}</span>
            ...
            {['atl', 'ath'].map((field, i) => (
              <div key={i}>
                <div className="flex flex-col items-start">
                  <span className="uppercase text-gray-500 dark:text-gray-500 font-semibold">{field}</span>
