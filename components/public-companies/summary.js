    ...
    <div className="w-full grid grid-flow-row grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 mb-2 md:mb-4">
      <div className="w-full">
        <Widget
          ...
          right={<BiBuildings size={32} className="stroke-current text-gray-500" />}
        />
      </div>
      <div className="w-ful">
        <Widget
      ...
      <div className="w-full">
        <Widget
          ...
          right={<BiDollarCircle size={32} className="stroke-current text-gray-500" />}
        />
      </div>
      <div className="w-full">
        <Widget
          ...
          right={<FiPieChart size={32} className="stroke-current text-gray-500" />}
        />
      </div>
    </div>
  )
