  ...
  return (
    <div className="flex relative">
      ...
      <div ref={popoverRef} { ...attributes.popper } style={styles.popper}>
        <div
          className={`w-auto max-w-xs no-underline break-words rounded-lg shadow-lg z-10 bg-white dark:bg-gray-800 border-0 border-gray-200 dark:border-gray-700 text-gray-900 dark:text-white text-sm font-normal ${hidden ? 'hidden' : 'block'}`}
          style={styles.offset}
        >
