          ...
          {watchlists_data.length === 1 ?
            ...
            <div className="relative">
              <button
                ...
                className="btn btn-flat btn-rounded bg-transparent hover:bg-gray-100 dark:hover:bg-gray-800 flex items-center p-2"
              >
