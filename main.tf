...
module "next_image_optimizer" {
  ...
  next_image_domains = ["assets.coingecko.com", "www.covalenthq.com", "logos.covalenthq.com", "subscan.l2me.com", "coinhippo.io", "www.coinhippo.io", "bitcoin.org", "ethereum.org", "bin.bnbstatic.com"]
}
